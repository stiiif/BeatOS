...
console.log("[Main] Starting module import...");
...
try {
    ...
    console.log("[Main] Core systems instantiated.");
    ...
    if (initBtn) {
        console.log("[Main] Init button found, attaching listener.");
        initBtn.addEventListener('click', async () => {
            console.log("[Main] Init button clicked.");
            try {
                await audioEngine.initialize();
                console.log("[Main] Audio engine initialized.");
                ...
                console.error("[Main] Error during audio initialization:", err);
                alert("Audio init failed: " + err.message);
            }
        });
    } else {
        console.error("[Main] FATAL: 'initAudioBtn' not found in DOM.");
    }
