(module
 ...
 (type $7 (func (param f32 f32 f32 f32 f32) (result f32)))
 ...
 (data $12 (i32.const 656) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\19\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "interpolateCubic" (func $assembly/index/interpolateCubic))
 (export "computeHermiteCoefficients" (func $assembly/index/computeHermiteCoefficients))
 ...
 (export "applyGainRamp" (func $export:assembly/index/applyGainRamp))
 (start $~start)
 (func $assembly/index/interpolateCubic (param $y0 f32) (param $y1 f32) (param $y2 f32) (param $y3 f32) (param $t f32) (result f32)
  (local $c0 f32)
  (local $c1 f32)
  (local $c2 f32)
  (local $c3 f32)
 ...
 (func $~lib/typedarray/Float32Array#__uset (param $this i32) (param $index i32) (param $value f32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/index/applyGainRamp (param $data i32) (param $startGain f32) (param $endGain f32)
  (local $len i32)
  (local $step f32)
  (local $currentGain f32)
  (local $i i32)
  (local $7 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assembly/index/computeHermiteCoefficients (param $y0 f32) (param $y1 f32) (param $y2 f32) (param $y3 f32) (result i32)
  (local $out i32)
  (local $5 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $export:assembly/index/applyGainRamp (param $0 i32) (param $1 f32) (param $2 f32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
  ...
  local.get $1
  local.get $2
  call $assembly/index/applyGainRamp
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
