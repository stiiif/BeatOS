(module
 ...
 (type $4 (func (param f32 f32 f32 f32 f32) (result f32)))
 ...
 (type $11 (func (param i32 f32 f32)))
 ...
 (data $12 (i32.const 1680) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\19")
 ...
 (start $~start)
 (func $assembly/index/interpolateCubic (param $0 f32) (param $1 f32) (param $2 f32) (param $3 f32) (param $4 f32) (result f32)
  local.get $3
  local.get $0
  f32.sub
  f32.const 0.5
 ...
 (func $assembly/index/computeHermiteCoefficients (param $0 f32) (param $1 f32) (param $2 f32) (param $3 f32) (result i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  global.get $~lib/memory/__stack_pointer
