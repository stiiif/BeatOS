export class AudioUtils {
    ...
    static audioBufferToWav(buffer: AudioBuffer, opt: { float32?: boolean } = {}): ArrayBuffer {
    ...
    private static encodeWAV(samples: Float32Array, numChannels: number, sampleRate: number, format: number, bitDepth: number): ArrayBuffer {
    ...
    private static writeFloat32(output: DataView, offset: number, input: Float32Array): void {
